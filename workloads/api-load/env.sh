...
# snappy
export SNAPPY_SERVER=${SNAPPY_SERVER:-http://ec2-34-220-107-152.us-west-2.compute.amazonaws.com:7070}
export SNAPPY_USER=${SNAPPY_USER}
export SNAPPY_PASSWORD=${SNAPPY_PASSWORD}

...
export BASELINE_HOSTNET_UUID=${BASELINE_POD_1P_UUID}
export BASELINE_POD_1P_UUID=${BASELINE_SVC_1P_UUID}
export BASELINE_POD_2P_UUID=${BASELINE_POD_2P_UUID}
export BASELINE_POD_4P_UUID=${BASELINE_POD_4P_UUID}
export BASELINE_SVC_1P_UUID=${BASELINE_SVC_1P_UUID}
export BASELINE_SVC_2P_UUID=${BASELINE_SVC_2P_UUID}
export BASELINE_SVC_4P_UUID=${BASELINE_SVC_4P_UUID}
export BASELINE_MULTUS_UUID=${BASELINE_MULTUS_UUID}

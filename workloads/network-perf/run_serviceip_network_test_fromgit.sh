...
if [[ ${ENABLE_SNAPPY_BACKUP} == "true" ]] ; then
 ...
 export workload=network_perf_serviceip_network_test
 
 export snappy_path="$SNAPPY_USER_FOLDER/$runid$platform-$cluster_version-$network_type/$SUUID-$workload/$folder_date_time/"
